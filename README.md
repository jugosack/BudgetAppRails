...
[Live demo here](https://budgetapprails.onrender.com/)
...
```sh
  cd BudgetAppRails
  git clone https://github.com/jugosack/BudgetAppRails.git 
```
...
Feel free to check the [issues page](https://github.com/jugosack/BudgetAppRails/issues)
